        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleRegistration = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone_Numbber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Resaurant_Owners", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Restaurants_Resaurant_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Resaurant_Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryDetail_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "3", null, "RestaurantOwner", "RESTAURANTOWNER" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "5a22b7b4-28e5-4a8d-9476-a34194e093a4", "Admin@gmail.com", true, "Admin", "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEDbQNYKur7FjdLZzuApnUEfXVHwDmH7A3bON98iy0BQTphI/u3zBVeoNXy4EmbAlPQ==", "012152001", true, "22e92869-38fc-4495-8a1d-38e1815354ba", false, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryDetail_DriverId",
